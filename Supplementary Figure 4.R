setwd("C:\\Users\\Dexin Chen\\Desktop\\Data")
...
ggplot(data=distribution_training,mapping=aes(x=ID,y=Collagen,fill=Subgroup,group=Subgroup)) +
...
ggplot(data=distribution_validation,mapping=aes(x=ID,y=Collagen,fill=Subgroup,group=Subgroup)) +
