...
Body <- (training_data$location2==1)+0
Cardia <- (training_data$location2==2)+0
...
Poor <- (training_data$differentiation2==2)+1
Undifferentiated <- (training_data$differentiation2==3)+1
